...
function createContainer() {
  ...
  dom_container.innerHTML = `
    ...
    <div class="help-container">
      <div class="show-help">Help?</div>
      <div class="hide-help">Close</div>

      <div class="help-content" title="viewing help">
        <div class="help-body">
          <h5 id="help-title">FAQ</h5>

          <div id="faq"><b>How does this work?</b></div>
          <div id="ans">This tool monitors your contrubition through time spoken, interruptions and constant talking.</div>

          <div id="faq"><b>How do I view live feedback?</b></div>
          <div id="ans">To view live feedback, click "View Live Feedback". To close live feedback, click "Hide".</div>

          <div id="faq"><b>How do I view personalised feedback?</b></div>
          <div id="ans">To view your personalised feedback, click "Call Ending?" This will produce a snapshot of your results up to that moment in time. This feature is designed to be used as a reflective tool at the end of the call.</div>

          <div id="faq"><b>What are interruptions?</b></div>
          <div id="ans">An interruption occurs when two users speak at the same time, those users are notified and an interruption is logged.</div>

          <div id="faq"><b>What is a soliloquy?</b></div>
          <div id="ans">A soliloquy is when a single member speaks continuously for 3 minutes without pause.</div>

          <div id="faq"><b>How is the score calculated?</b></div>
          <div id="ans">The score is generated by calcualting how close you are to the ideal talk percent and removing points for soliloquys and interruptions.</div>
  ...
  onclick('.show-help', ()=>{ dom_container.classList.add("show_help"); });
  onclick('.hide-help', ()=>{ dom_container.classList.remove("show_help"); });
